...
FLASHMEM void settingsAfterTouch(char *value) {
...
FLASHMEM void settingsNotePriority(char *value) {
...
FLASHMEM void settingsFilterLoop(char *value) {
...
FLASHMEM void settingsAmpLoop(char *value) {
...
FLASHMEM void settingsClockSource(char *value) {
...
FLASHMEM void settingsafterTouchDepth(char *value) {
...
FLASHMEM void settingsFilterEnv(char *value) {
...
FLASHMEM void settingsAmpEnv(char *value) {
  if (strcmp(value, "Logarithmic") == 0) {
    ampLogLin = true;
  } else {
    ampLogLin = false;
...
FLASHMEM int currentIndexAfterTouch() {
  return getAfterTouch();
}

FLASHMEM int currentIndexNotePriority() {
  return getNotePriority();
}

FLASHMEM int currentIndexFilterLoop() {
  return getFilterLoop();
}

FLASHMEM int currentIndexAmpLoop() {
  return getAmpLoop();
}

FLASHMEM int currentIndexClockSource() {
  return getClockSource();
}

FLASHMEM int currentIndexafterTouchDepth() {
  return getafterTouchDepth();
}

FLASHMEM int currentIndexFilterEnv() {
